...
const LoginForm = ({ user, login, signInWithGoogle, userError }) => {
		...
		<div className="container">
			<form onSubmit={(e) => e.preventDefault()} className="form login">
				<div className="form-content">
					...
					{userError.loginError && <div className='form__error'>{userError.loginError}</div>}
					<div>
					...
					<div>
						...
						>
							<img className="button-img" src={googleIcon} alt="google icon" />
							Sign in with Google
						</button>
					</div>
				</div>
